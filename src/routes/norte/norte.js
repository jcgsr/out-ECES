...
export let norte = [
  ...
  },
  {
    ...
    aparic: 12,
    obra: 'Introdução à teoria e à prática do latim'
  },
  {
    id: increment(getCount),
    autor: 'RONAI, Paulo',
...

  {
    ...
    autor: 'AMARANTE, José',
    aparic: 5,
    obra: 'Latinitas: leitura de textos em língua latina. Elegias, poesia épica, odes'
  },
  {
    id: increment(getCount),
    autor: 'BRUNO, Haroldo',
  ...
  {
    id: increment(getCount),
    autor: 'COUTINHO, Ismael De Lima',
    aparic: 5,
    obra: 'Pontos de gramática histórica'
  },
  {
    id: increment(getCount),
  ...
  },
  {
    ...
    autor: 'AMARANTE, José',
    aparic: 4,
    obra: 'Latinitas: leitura de textos em língua latina. Fábulas, epigramas, epístolas'
  },
  {
    id: increment(getCount),
  ...
  {
    id: increment(getCount),
    autor: 'FIGUEIREDO E ALMEIDA, José Nunes de',
    aparic: 4,
  ...
  { id: increment(getCount), autor: 'MORISSET, R.', aparic: 4, obra: 'Les Lettres Latines' },
  {
    id: increment(getCount),
